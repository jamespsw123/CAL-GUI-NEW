...
# panel4(Right Pane)
		...
		StartBox = wx.StaticBox(panel4,label='Start',style=wx.TE_CENTRE)
...
#---------------------------------------------------------------------------------------------
	...
	def on_redraw_timer(self, event):
		...
		#print temp
		self.Furnace1_Temp.append(temp) 
	...
	def onPreview2(self, event):
		...
		# 1 stepper motor step equals 1.8 degree,
		# 16 micro-steps equals 1 step
		distance_ = int(float(1344 - self.position2)*(3200/(math.pi*70)))
		distance_ = str(distance_)
		Distance = distance_ + 'Dis'  
		# convert speed unit rpm to stepper motor's microsteps/sec
		speed_ = int(float(self.speed)*(3200/60))
	...
	def onPreview3(self, event):
		...
		# 1 stepper motor step equals 1.8 degree,
		# 16 micro-steps equals 1 step
		distance_ = int(float(837 - self.position3)*(3200/(math.pi*70)))
		distance_ = str(distance_)
		Distance = distance_ + 'Dis'  
		# convert speed unit rpm to stepper motor's microsteps/sec
		speed_ = int(float(self.speed)*(3200/60))
	...
	def onPreview4(self, event):
		...
		# 1 stepper motor step equals 1.8 degree,
		# 16 micro-steps equals 1 step
		distance_ = int(float(556 - self.position4)*(3200/(math.pi*70)))
		distance_ = str(distance_)
		Distance = distance_ + 'Dis'  
		# convert speed unit rpm to stepper motor's microsteps/sec
		speed_ = int(float(self.speed)*(3200/60))
	...
	def setSampleLength(self, event):
		adjestion = self.sl.GetValue()
		self.sld1.SetMax(254 - adjestion)
		self.sld2.SetMax(407 - adjestion)
		self.sld3.SetMax(205 - adjestion)
		self.sld4.SetMax(407 - adjestion)
