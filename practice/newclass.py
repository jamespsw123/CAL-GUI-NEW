...
class Example(wx.Frame):
	...
	def InitUI(self):
		...
		text1 = wx.StaticText(panel, label='Stepper Motor')

		sizer.Add(text1, pos=(0, 0), flag=wx.TOP|wx.LEFT|wx.BOTTOM,
			border=15)

		icon = wx.StaticBitmap(panel, bitmap=wx.Bitmap('stm2.png'))
		...
		text2 = wx.StaticText(panel, label='Distance')
		sizer.Add(text2, pos=(2, 0), flag=wx.LEFT, border=10)

		tc1 = wx.TextCtrl(panel)
		sizer.Add(tc1, pos=(2, 1), span=(1, 3), flag=wx.TOP|wx.EXPAND)

		text3 = wx.StaticText(panel, label='Speed')
		...
		text4 = wx.StaticText(panel, label='Direction')
		sizer.Add(text4, pos=(4, 0), flag=wx.TOP|wx.LEFT, border=10)

		combo3 = wx.ComboBox(panel, style=wx.CB_DROPDOWN|wx.CB_READONLY,
